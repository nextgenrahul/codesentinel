  ...
  return (
    <Sidebar>
      ...
      <SidebarContent className="px-3 py-6 flex-col gap-1">
        <div className="mb-2">
          <p className="text-xs font-semibold text-sidebar-foreground/60 px-3 mb-3 uppercase tracking-normal">
            Menu
          </p>
        </div>
              ...
              <DropdownMenuTrigger asChild>
                ...
                >
                  ...
                  <div className="grid flex-1 text-left text-sm leading-relaxed min-w-0">
                    ...
                    <span className="truncate font-xs text-sidebar-foreground/70">
                      {userEmail}
                    </span>
                  </div>
                </SidebarMenuButton>
